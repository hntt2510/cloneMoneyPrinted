...
project_name = _cfg.get("project_name", "Video Research & Asset Builder")
project_description = _cfg.get(
    "project_description",
    "Video Research & Asset Builder, evolved from "
    "<a href='https://github.com/harry0703/MoneyPrinterTurbo'>MoneyPrinterTurbo</a>",
)
